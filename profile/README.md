...
- 🧪 [**`testIHM`**](https://github.com/IUTInfoAix-R202/testIHM) - archive des 10 sujets de tests d'IHM 2013-2022 sur la stack Java 25 / JavaFX 25 / Maven Wrapper, à utiliser comme entraînement pour le CC3
...
`syllabus`, `cours`, `tp1` à `tp5` et des ressources (`FranceFx`, `SAE201`,
`tutoJDBC`, `tutoJPA`, `tutoMaven`, `presentationDNE`).
...
*Contact : [sebastien.nedjar@univ-amu.fr](mailto:sebastien.nedjar@univ-amu.fr) · IUT d'Aix-Marseille - Département Informatique - 2025-2026*
